...
import { requirePrincipal, type AppModule } from "@/lib/olv/session";
...
const modules = [
  ...
  { module:"CALENDAR", name: "Calendar", eyebrow: "TIME OPERATIONS", description: "Plan meetings, deadlines and focused work in your private calendar.", href: "/app/calendar", icon: "□", active: true },
...
export default async function OLVApp() {
  ...
  const allowed=modules.filter((module)=>principal.orgRole==="ADMIN"||principal.modules.includes(module.module as AppModule));
